...
public class CompanyValuationTests : TestingBase
{
    ...
    {
        var result = await api.GetLatestStockNewsAsync(limit: 5);
    ...
    {
        var result = await api.GetStockNewsAsync("AAPL", limit: 5);
    ...
    {
        var result = await api.GetStockNewsAsync(new[] { "AAPL", "MSFT" }, limit: 5);
    ...
    {
        var result = await api.GetHistoricalMarketCapitalizationAsync("AAPL", limit: 5);
