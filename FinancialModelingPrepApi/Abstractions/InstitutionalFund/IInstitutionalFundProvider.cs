...
public interface IInstitutionalFundProvider
{
    ...
    /// </summary>
    /// <returns></returns>
    Task<ApiResponse<List<CikListResponse>>> Get13FListAsync();
    ...
    /// <returns></returns>
    Task<ApiResponse<CusipMapperResponse>> MapCusipAsync(string cusip);
    ...
    /// <returns></returns>
    Task<ApiResponse<List<CikListResponse>>> SearchCikByName(string name);
    ...
    /// <returns></returns>
    Task<ApiResponse<List<CikListResponse>>> GetCompanyNameByCik(string cik);
    ...
    /// <returns></returns>
    Task<ApiResponse<List<Form13FResponse>>> GetForm13FAsync(string cik, string year, string quarter);
    #endregion
}